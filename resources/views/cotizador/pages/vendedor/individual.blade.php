    ...
    <div class="container-fluid card-section mt-3">
        ...
        <div class="row d-flex justify-content-center text-center">
            ...
            <div class="col mt-3" id="divbtnCalcular">
                <button class="btn btn-info btn-estandar" type="button" id="button-addon2"><i class="uil uil-calculator"></i> Calcular</button>
            </div>
            ...
            <div class="row m-3 d-flex flex-wrap" id="divTablasCotInd">
                ...
                <div class="col">
                    <div>
                        <table class="table table-hover">
                            <thead>
                            <th colspan="2" class="table-primary">COSTOS <i class="uil uil-usd-circle"></i></th>
                            </thead>
                            <tr>
